...
\begin{document}
    ...
    \input{content/stateMachineDesign.tex}
    \input{content/packetFormats.tex}
    \input{content/proofs.tex}
 ...
 %   \bibliographystyle{IEEEtran} %TODO: Resolve mapping issues
    ...
    %shrink space between bibliography and acknowledgements
    \vskip 0pt plus -1fil
    \input{content/acknowledgement.tex}
    
    %shrink space between acknowledgement and biography
    \vskip 0pt plus -1fil
